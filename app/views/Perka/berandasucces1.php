...
<body>
 ...
 <div class="row">
  <div class="large-12 columns">
    ...
    <a href="#" id="buttonKegiatan3" data-reveal-id="myModal5" hidden></a>
    ...
    <div id="myModal2" class="reveal-modal small" align="center">          
      ...
      <a class="button radius b1" id="buttonKegiatan1">Ajukan Kegiatan</a>     
    </div>    
    ...
    <div id="myModal5" class="reveal-modal small">        
      <h4 class="h2b subheader">
